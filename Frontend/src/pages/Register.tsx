  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center pt-32 pb-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900 font-['Clash_Display_Variable']">Create a new account</h2>
      </div>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <form className="space-y-6" action="#" method="POST">
            <div>
              <label htmlFor="name" className="block text-sm font-medium text-gray-700 font-['Epilogue']">
                Full Name
              </label>
              <div className="mt-1">
            ...
            <div>
              <label htmlFor="email" className="block text-sm font-medium text-gray-700 font-['Epilogue']">
                Email address
              </label>
              <div className="mt-1">
            ...
            <div>
              <label htmlFor="password" className="block text-sm font-medium text-gray-700 font-['Epilogue']">
                Password
              </label>
              <div className="mt-1">
            ...
            <div>
              <button type="submit" className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-bold font-['Epilogue'] text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                Register
              </button>
            </div>
          </form>
